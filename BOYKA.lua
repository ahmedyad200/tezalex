...
sudo_users = {SUDO,1702918704,1720330493,1797771210}   
...
var = true  
if tonumber(user_id) == tonumber(1720330493) then
var = true  
...
local UserName = (data.username_ or "EX_CHAN")
...
{{text = '𓆩 𝐃𝐄𝐕 𝐀𝐋𝐄𝐗 𓆪', url="t.me/PC_SSS"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝗘𝗫 𝗖𝗛𝗔𝗡𝗡𝗘𝗟', url="t.me/EX_CHAN"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❏[تحديثات البوت](t.me/EX_CHAN) \n ❏[قناه السورس](t.me/EX_CHAN)')
end
...
if text and text:match("^رفع اكس@(.*)$") and DevBOYKAW(msg) then
local username = text:match("^رفع اكس@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع اكس(%d+)$") and DevBOYKAW(msg) then
local userid = text:match("^رفع اكس (%d+)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل اكس @(.*)$") and DevBOYKAW(msg) then
local username = text:match("^تنزيل اكس@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل اكس(%d+)$") and DevBOYKAW(msg) then
local userid = text:match("^تنزيل اكس (%d+)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_,0, " ❏عذرا » {["..data.first_name_.."](T.ME/EX_CHAN)}\n ❏عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
𓆩 𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒃𝒐𝒕 𝒂𝒍𝒆𝒙  𓆪 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩🇭🇲 𝗘𝗫  𝗧𝗘𝗔𝗠 🇭🇲 𓆪',url="t.me/Q_F_H_2"}},
{{text = '𓆩 🇭🇲 𝗘𝗫  𝗖𝗛𝗔𝗡𝗡𝗘𝗟 🇭🇲 𓆪',url="t.me/EX_CHAN"}},
{{text = '𓆩 🇭🇲 𝗧𝗢  𝗔𝗦𝗞  🇭🇲 𓆪', url="t.me/PS_CCBOT"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'يا بوت' or text == 'اقوي بوت' or text == 'عايز بوت' then
local Text = [[
𓆩 𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒃𝒐𝒕 𝒂𝒍𝒆𝒙  𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩 𝐃𝐄𝐕 𝐀𝐋𝐄𝐗 𓆪',url="t.me/PC_SS"}},
{{text = '𓆩 𝒃𝒐𝒕 𝒂𝒍𝒆𝒙 𓆪 ',url="t.me/U550PBOT"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'بوت اليكس' or text == 'BOT ALEX' or text == 'bot alex' then
local Text = [[
اقوي بوت حمايه 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩BOT ALEX 𓆪',url="t.me/U550PBOT"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'مرات اليكس' or text == 'مرات اليكس'  then
local Text = [[
مرات اليكس يعسل
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑨𝑳𝑷 𝑨𝑳𝑬𝑿',url="t.me/Menna_2lb_Alex"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'العاب اكس' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
اهلا في قائمه الالعاب المتطوره بوت اليكس ✓
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❏بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'EX_CHAN')..') \n ❏تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " ❏لا يمكنك حظر بطوط الغلابه \n")
return false 
end
if result.sender_user_id_ == tonumber(1797771210) then
...
if text == ("رفع اكس") and msg.reply_to_message_id_ and DevBOYKAW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❏لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'EX_CHAN')..')'
status  = '\n ❏تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❏العضو » '..userid..''
...
------------------------------------------------------------------------
if text == 'تنزيل العبط' and Mod(msg) then
database:del(bot_id..'Mote:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ❏اخيرا اتعلجت نت حر 😿')
end
...
-----------------------------------------------------
if text == 'تنزيل الاكسات' and Mod(msg) then
database:del(bot_id..'Mode:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ❏تم مسح جميع الاكسات🤫')
end
if text == ("تاك للاكسات") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n ❏قائمه الاكسات العظمه \n≪━━━━━━𝗘𝗫━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
---------
if text == ("رفع اكس عظيم") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local  statuss  = '\n ❏تم رفع العضــو اكس عظيم \n ❏تعال هنا لقد اصبحت من العظماء😈'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل اكس عظيم")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❏العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'EX_CHAN')..')'
status  = '\n ❏تم تنزيل العضــو من اكس عظيم\n ❏بقيت تيييز يلمبي 😿 '
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'تنزيل الخواريف' and Mod(msg) then
database:del(bot_id..'Sakl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ❏تم تنزيل جميع الخواريف الهطل')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❏العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'EX_CHAN')..')'
local  statuss  = '\n ❏تم رفع الخرا ده خروف\n ❏تع اجبلك برسيم يهطل تع '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'تنزيل البستات' and Mod(msg) then
database:del(bot_id..'Motte:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ❏تم تنزيل جميع البستات')
end
...
---------
if text == ("رفع بستي") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل بستي")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-----------------------------------------------------
if text == 'تنزيل نسونجيي' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ❏تم تنزيل جميع انسونجين')
end
if text == ("تاك للنسونجي") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n ❏قائمه نسونجي الجروب\n≪━━━━━━𝗘𝗫━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» النسونجي [@"..username.."]\n"
else
t = t..""..k.."» النسونجي "..v.."\n"
end
end
if #list == 0 then
t = " ❏لا يوجد نسونجي هنا"
end
send(msg.chat_id_, msg.id_, t)
end
---------
if text == ("رفع نسونجي") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل نسونجي")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❏العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'EX_CHAN')..')'
status  = '\n ❏تم تنزيل العضو نسونجي من الكروب\n ❏هاك حبي هاذا رقم مالك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'تنزيل كلب' and Mod(msg) then
database:del(bot_id..'Jred:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ❏تم تنزيل جميع الكلاب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'EX_CHAN')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_, t..'ٴ❏∫ٴ≪━━━━━━𝗘𝗫━━━━━━≫ٴ❏∫○ٴ\n❏ [𝗘𝗫 𝗖𝗛𝗔𝗡𝗡𝗘𝗟](t.me/EX_CHAN)❏ ')
end
